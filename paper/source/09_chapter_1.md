...
<!-- 
To include a reference, add the citation key shown in the library.bib file.
-->

To include a citation to the text, just add the citation key shown in the library.bib file. The style of the citation is determined by the ref_format.csl file. For example, in The Living Sea you can find pictures of the Calypso [@Madl2016].
